// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_8K\K_Means_ip_fifo_eol_out.v
...
// -------------------------------------------------------------
// 
// Module: K_Means_ip_fifo_eol_out
// Source Path: K_Means_ip/K_Means_ip_axi4_stream_video_master/K_Means_ip_fifo_eol_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module K_Means_ip_fifo_eol_out
  ...
  K_Means_ip_fifo_eol_out_classic u_K_Means_ip_fifo_eol_out_classic_inst (.clk(clk),
                                                                          .reset(reset),
                                                                          .enb(enb),
                                                                          .In(In),  // ufix1
...
endmodule  // K_Means_ip_fifo_eol_out
