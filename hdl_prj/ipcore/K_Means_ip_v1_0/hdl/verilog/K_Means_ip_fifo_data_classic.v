// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_8K\K_Means_ip_fifo_data_classic.v
...
// -------------------------------------------------------------
// 
// Module: K_Means_ip_fifo_data_classic
// Source Path: K_Means_ip/K_Means_ip_axi4_stream_video_slave/K_Means_ip_fifo_data/K_Means_ip_fifo_data_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module K_Means_ip_fifo_data_classic
  ...
  K_Means_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                       ...
                                       u_K_Means_ip_fifo_data_classic_ram (.clk(clk),
                                                                           .enb(enb),
                                                                           .wr_din(In),
                                                                           .wr_addr(w_waddr),
                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // K_Means_ip_fifo_data_classic
