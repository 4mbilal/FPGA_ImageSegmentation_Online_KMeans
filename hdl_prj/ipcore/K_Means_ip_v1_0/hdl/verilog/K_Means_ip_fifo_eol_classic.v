// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_8K\K_Means_ip_fifo_eol_classic.v
...
// -------------------------------------------------------------
// 
// Module: K_Means_ip_fifo_eol_classic
// Source Path: K_Means_ip/K_Means_ip_axi4_stream_video_slave/K_Means_ip_fifo_eol/K_Means_ip_fifo_eol_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module K_Means_ip_fifo_eol_classic
  ...
  K_Means_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                         ...
                                         u_K_Means_ip_fifo_eol_classic_ram (.clk(clk),
                                                                            .enb(enb),
                                                                            .wr_din(In),  // ufix1
                                                                            .wr_addr(w_waddr),
                                                                            .wr_en(w_we),  // ufix1
...
endmodule  // K_Means_ip_fifo_eol_classic
