// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_8K\K_Means_ip_src_Color_Space_Converter1.v
...
// -------------------------------------------------------------
// 
// Module: K_Means_ip_src_Color_Space_Converter1
// Source Path: Sementation_8K/Segmentation_HW/K-Means/Color Space Converter1
// Hierarchy Level: 2
// 
...
module K_Means_ip_src_Color_Space_Converter1
  ...
  K_Means_ip_src_YCBCR2RGB u_ycbcr2rgbNet_inst (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .Y(In1Reg),  // uint8
                                                .Cb(In2Reg),  // uint8
...
endmodule  // K_Means_ip_src_Color_Space_Converter1
