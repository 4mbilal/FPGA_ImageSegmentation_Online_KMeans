// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_8K\K_Means_ip_fifo_data_OUT_classic.v
...
// -------------------------------------------------------------
// 
// Module: K_Means_ip_fifo_data_OUT_classic
// Source Path: K_Means_ip/K_Means_ip_axi4_stream_video_master/K_Means_ip_fifo_data_OUT/K_Means_ip_fifo_data_OUT_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module K_Means_ip_fifo_data_OUT_classic
  ...
  K_Means_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                         .DataWidth(32)
                                         )
                                       u_K_Means_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                       .enb(enb),
                                                                                       .wr_din(In),
                                                                                       .wr_addr(w_waddr),
                                                                                       .wr_en(w_we),  // ufix1
...
endmodule  // K_Means_ip_fifo_data_OUT_classic
