Muhammad Bilal (4mbilal@gmail)

* This Simulink model generates HDL files for K-means clustering IP core with AXI4 streaming interface.

* The code is provided as it is and is no longer maintained
